...
from ..models.composition_models import Motif, Melody, MelodicDevelopment, DevelopmentTechnique, Phrase, MelodyVariation
...
class MotifDeveloper:
    ...
    def develop_motif(self, motif: Motif, techniques: List[str], target_length: int = 8) -> MelodicDevelopment:
        """
    ...
    def _analyze_intervallic_preservation(self, motif: Motif, developed_notes: List[int]) -> float:
        ...
        developed_intervals = [developed_notes[i + 1] - developed_notes[i] for i in range(len(developed_notes) - 1)]
...
class PhraseGenerator:
    ...
    def create_phrase(
        self, chord_progression: List[str], key: str, phrase_type: str = "period", style: str = "vocal"
    ) -> Phrase:
        """
        ...
        melody = Melody(notes=melody_notes, rhythm=rhythm, phrase_structure={"type": phrase_type})
    ...
    def _generate_cadences(self, phrase_type: str, progression: List[str]) -> List[Dict[str, Any]]:
        ...
        if phrase_type == "period":
            ...
            cadences.append({"type": "half_cadence", "location": "mid_phrase", "chords": ["I", "V"]})
            # Authentic cadence at end
            cadences.append({"type": "authentic_cadence", "location": "phrase_end", "chords": ["V", "I"]})
        else:
...
class MelodyVariator:
    ...
    def create_variation(self, original_melody: List[int], variation_type: str = "embellishment") -> MelodyVariation:
        """
