...
class MuspyIntegration:
    ...
    def add_chord_to_music(
        self, music, chord_notes: List[int], start_time: int, duration: int, velocity: int = 80
    ) -> bool:
        ...
        try:
            ...
            for pitch in chord_notes:
                note = self.muspy.Note(time=start_time, pitch=pitch, duration=duration, velocity=velocity)
