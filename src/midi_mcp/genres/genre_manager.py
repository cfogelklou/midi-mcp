...
class GenreManager:
    ...
    def _create_default_genre_data(self, genre: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "progressions": {"standard": {"pattern": ["I", "V", "vi", "IV"], "bars": 4, "variations": []}},
            "rhythms": {"standard": {"feel": "straight", "emphasis": [1, 3], "subdivision": "quarter"}},
            "scales": ["major", "minor"],
            "instrumentation": {"essential": ["piano"], "typical": ["bass", "drums"], "optional": ["guitar", "vocals"]},
            "characteristics": {"energy": "medium", "complexity": "medium", "mood": "neutral"},
        }
    ...
    def _calculate_relationship_score(self, genre1: str, genre2: str) -> float:
        ...
        if genre1_info.get("parent") and genre1_info.get("parent") == genre2_info.get("parent"):
            return 0.7
        ...
        if key_analysis and "key_preferences" in genre_data:
            ...
            if detected_mode in genre_data["key_preferences"]:
                ...
                analysis["suggestions"].append(
                    f"Consider using {genre_data['key_preferences'][0]} mode for more authentic {target_genre}"
                )
