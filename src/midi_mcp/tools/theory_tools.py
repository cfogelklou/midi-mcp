...
def register_theory_tools(app: FastMCP, tool_registry: ToolRegistry) -> None:
    ...
    async def get_scale_notes(root_note: str, scale_type: str, octave: int = 4) -> List[TextContent]:
        ...
        try:
            ...
            return [TextContent(
                type="text",
                text=f"Error generating scale: {str(e)}"
            )]
    ...
    async def identify_intervals(notes: List[int]) -> List[TextContent]:
        ...
        try:
            ...
            return [TextContent(
                type="text",
                text=json.dumps(intervals, indent=2)
            )]
            
        except Exception as e:
            return [TextContent(
                type="text",
                text=f"Error identifying intervals: {str(e)}"
            )]
    ...
    async def transpose_to_key(notes: List[int], from_key: str, to_key: str) -> List[TextContent]:
        ...
        try:
            ...
            return [TextContent(
                type="text",
                text=f"Error transposing: {str(e)}"
            )]
    
    # Chord Tools
    @app.tool(name="build_chord")
    async def build_chord(root_note: str, chord_type: str, inversion: int = 0, 
                         voicing: str = "close") -> List[TextContent]:
        """
        ...
        try:
            ...
            return [TextContent(
                type="text",
                text=f"Error building chord: {str(e)}"
            )]
    ...
    async def analyze_chord(notes: List[int]) -> List[TextContent]:
        ...
        try:
            ...
            return [TextContent(
                type="text",
                text=f"Error analyzing chord: {str(e)}"
            )]
    ...
    async def get_chord_tones_and_extensions(chord_symbol: str) -> List[TextContent]:
        ...
        try:
            ...
            return [TextContent(
                type="text",
                text=f"Error analyzing chord symbol: {str(e)}"
            )]
    
    # Progression Tools
    @app.tool(name="create_chord_progression")
    async def create_chord_progression(key: str, progression: List[str], 
                                     duration_per_chord: float = 1.0) -> List[TextContent]:
        """
        ...
        try:
            chord_progression = progression_manager.create_chord_progression(
                key, progression, duration_per_chord
            )
            ...
            return [TextContent(
                type="text",
                text=f"Error creating chord progression: {str(e)}"
            )]
    ...
    async def analyze_progression(chord_symbols: List[str], key: Optional[str] = None) -> List[TextContent]:
        ...
        try:
            ...
            return [TextContent(
                type="text",
                text=f"Error analyzing progression: {str(e)}"
            )]
    
    @app.tool(name="suggest_next_chord")
    async def suggest_next_chord(current_progression: List[str], key: str,
                               style: str = "common_practice") -> List[TextContent]:
        """
        ...
        try:
            ...
            return [TextContent(
                type="text",
                text=f"Error suggesting next chord: {str(e)}"
            )]
    ...
    async def detect_key(midi_notes: List[int]) -> List[TextContent]:
        ...
        try:
            ...
            return [TextContent(
                type="text",
                text=f"Error detecting key: {str(e)}"
            )]
    ...
    async def suggest_modulation(from_key: str, to_key: str) -> List[TextContent]:
        ...
        try:
            ...
            return [TextContent(
                type="text",
                text=f"Error suggesting modulation: {str(e)}"
            )]
    ...
    async def validate_voice_leading(chord_symbols: List[str]) -> List[TextContent]:
        ...
        try:
            ...
            return [TextContent(
                type="text",
                text=f"Error validating voice leading: {str(e)}"
            )]
    
    # Comprehensive Analysis Tool
    @app.tool(name="analyze_music")
    async def analyze_music(midi_notes: List[int], 
                           timestamps: Optional[List[float]] = None) -> List[TextContent]:
        """
        ...
        try:
            ...
            return [TextContent(
                type="text",
                text=f"Error analyzing music: {str(e)}"
            )]
    ...
    async def get_available_scales() -> List[TextContent]:
        ...
        try:
            ...
            return [TextContent(
                type="text",
                text=json.dumps(scales, indent=2)
            )]
        except Exception as e:
            return [TextContent(
                type="text",
                text=f"Error getting scales: {str(e)}"
            )]
    ...
    async def get_common_progressions(style: Optional[str] = None) -> List[TextContent]:
        ...
        try:
            ...
            return [TextContent(
                type="text",
                text=json.dumps(progressions, indent=2)
            )]
        except Exception as e:
            return [TextContent(
                type="text",
