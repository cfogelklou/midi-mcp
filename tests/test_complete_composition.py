...
class TestCompositionAnalyzer:
    ...
    def test_analyze_harmonic_quality(self):
        ...
        vl_suggestions = [s for s in analysis.improvement_suggestions 
                         if "voice leading" in s.suggestion.lower()]
    ...
    def test_analyze_structural_quality(self):
        ...
        structure_suggestions = [s for s in analysis.improvement_suggestions
                               if "structure" in s.suggestion.lower() or 
                                  "section" in s.suggestion.lower()]
    ...
    def test_overall_quality_scoring(self):
        ...
        category_avg = sum(cat.score for cat in analysis.category_scores.values() 
                          if cat != analysis.category_scores["overall"]) / 4
...
class TestCompositionRefiner:
    ...
    def test_refine_form(self):
        ...
        composition = CompleteComposition(
            structure={
                "sections": [
                    {"type": "verse", "duration": 200}  # One giant section
                ]
            }
        )
    ...
    def test_comprehensive_refinement(self):
        ...
        refined = refiner.refine_composition(
            composition=composition,
            focus_areas=["melody", "harmony", "form"]
        )
