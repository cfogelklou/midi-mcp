...
class TestCompositionFeatures:
    ...
    async def test_create_song_structure_pop(self, server):
        ...
        result = await server.call_tool("create_song_structure", {
            "genre": "pop",
            "song_type": "standard",
            "duration": 180
        })
    ...
    async def test_generate_song_section_verse(self, server):
        ...
        result = await server.call_tool("generate_song_section", {
            "section_type": "verse",
            "genre": "pop",
            "key": "C major"
        })
    ...
    async def test_create_section_transitions(self, server):
        ...
        verse_result = await server.call_tool("generate_song_section", {
            "section_type": "verse",
            "genre": "rock",
            "key": "G major"
        })
        
        chorus_result = await server.call_tool("generate_song_section", {
            "section_type": "chorus", 
            "genre": "rock",
            "key": "G major"
        })
        ...
        # Create transition
        transition_result = await server.call_tool("create_section_transitions", {
            "from_section": verse_result["data"],
            "to_section": chorus_result["data"],
            "transition_type": "buildup"
        })
    ...
    async def test_develop_melodic_motif(self, server):
        ...
        result = await server.call_tool("develop_melodic_motif", {
            "motif": motif,
    ...
    async def test_create_melodic_phrase(self, server):
        ...
        result = await server.call_tool("create_melodic_phrase", {
    ...
    async def test_vary_melody_for_repetition(self, server):
        ...
        result = await server.call_tool("vary_melody_for_repetition", {
            "original_melody": original_melody,
            "variation_type": "embellishment"
        })
    ...
    async def test_optimize_voice_leading(self, server):
        ...
        result = await server.call_tool("optimize_voice_leading", {
            "chord_progression": progression,
            "voice_count": 4
        })
    ...
    async def test_add_chromatic_harmony(self, server):
        ...
        result = await server.call_tool("add_chromatic_harmony", {
    ...
    async def test_create_bass_line_with_voice_leading(self, server):
        ...
        result = await server.call_tool("create_bass_line_with_voice_leading", {
            "chord_progression": progression,
            "style": "walking"
        })
    ...
    async def test_arrange_for_ensemble(self, server):
        ...
        result = await server.call_tool("arrange_for_ensemble", {
    ...
    async def test_create_counter_melodies(self, server):
        ...
        result = await server.call_tool("create_counter_melodies", {
    ...
    async def test_orchestrate_texture_changes(self, server):
        ...
        result = await server.call_tool("orchestrate_texture_changes", {
            "composition": composition,
    ...
    async def test_compose_complete_song(self, server):
        ...
        result = await server.call_tool("compose_complete_song", {
    ...
    async def test_analyze_composition_quality(self, server):
        ...
        result = await server.call_tool("analyze_composition_quality", {
            "composition": composition
        })
    ...
    async def test_refine_composition(self, server):
        ...
        result = await server.call_tool("refine_composition", {
            "composition": composition,
            "focus_areas": ["melody", "harmony"]
        })
    ...
    async def test_full_composition_workflow(self, server):
        ...
        structure_result = await server.call_tool("create_song_structure", {
            "genre": "pop",
            "song_type": "standard", 
            "duration": 120
        })
        ...
        for section_info in structure_result["data"]["sections"][:3]:  # First 3 sections
            section_result = await server.call_tool("generate_song_section", {
        ...
        arrangement_result = await server.call_tool("arrange_for_ensemble", {
            "composition": composition,
        ...
        analysis_result = await server.call_tool("analyze_composition_quality", {
            "composition": arrangement_result["data"]
        })
        
        # Verify workflow completion
        assert all(result["status"] == "success" for result in [
            structure_result, arrangement_result, analysis_result
        ])
