...
class TestVoiceLeadingManager:
    ...
    def test_create_four_part_harmony(self, voice_leading_manager, chord_manager):
        ...
        harmony = voice_leading_manager.create_four_part_harmony(
            melody_notes, chord_progression
        )
    ...
    def test_motion_classification(self, voice_leading_manager):
        ...
        motion_type_contrary = voice_leading_manager._classify_motion(
            note1a, note1b, note2a_contrary, note2b_contrary
        )
        ...
        motion_type_oblique = voice_leading_manager._classify_motion(
            note1a, note1b, note2a_oblique, note2b_oblique
        )
