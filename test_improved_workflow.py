...
async def test_complete_workflow():
    ...
    midi_file_id = file_manager.create_midi_file(title="Test Sad Ballad", tempo=72, key_signature="Am")
    ...
    composition_data = {
        ...
        "song_structure": {
            "sections": [
                {"type": section.type.value, "duration": section.duration} for section in composition.structure.sections
            ]
        },
    }
